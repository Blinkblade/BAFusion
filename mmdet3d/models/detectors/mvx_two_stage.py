...
class MVXTwoStageDetector(Base3DDetector):
    ...
    def extract_feat(self, batch_inputs_dict: dict,
        ...
        # ========================= pts_feats in mvx_two_stage type is <class 'list'> =========================
        # ========================= pts_feats in mvx_two_stage len is 1 =========================
        # ========================= pts_feats0 in mvx_two_stage shape is torch.Size([4, 512, 180, 180]) =========================

        # print("========================= pts_feats in mvx_two_stage type is {} =========================".format(type(pts_feats)))
        # print("========================= pts_feats in mvx_two_stage len is {} =========================".format(len(pts_feats)))
        # print("========================= pts_feats0 in mvx_two_stage shape is {} =========================".format(pts_feats[0].shape))
    ...
    def predict(self, batch_inputs_dict: Dict[str, Optional[Tensor]],
        ...
        img_feats, pts_feats = self.extract_feat(batch_inputs_dict,
                                                 batch_input_metas)
        # 这里输入了pts_feats和batch data samples
