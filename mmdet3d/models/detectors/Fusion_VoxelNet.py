...
@MODELS.register_module("FusionVoxelNet")
class FusionVoxelNet(SingleStage3DDetector):
    ...
    def __init__(self,
        ...
        if compress_layer:
            ...
            print("====================get type of {} position_embedding layer===================".format(compress_layer["type"]))
        print("=======================FusionVoxelNet for detectors.voxel is used====================")
        pass
    ...
    def extract_feat(self, batch_inputs_dict: dict) -> Tuple[Tensor]:
        ...
        # print("======================pts middle_encoder shape:{}======================".format(x.shape))
        # 如果有图像分支就进入图像分支
        if self.with_img_backbone:
            ...
            if self.with_cross_attention:
                ...
                # print("=================encoded_pts_feat shape {} =================".format(encoded_pts_feat.shape))
                if self.attention_type == "SoftmaxCrossAttention" or "CrossFocusedLinearAttention":
                    # FA系列，输入顺序为query, key, value, H, W
                    # H和W不需要
                    fusion_feature = self.cross_attention(encoded_pts_feat,key_img_feats,value_img_feats,H=H,W=W)
                    pass
                else:
...
# 双向注意力融合
@MODELS.register_module("BiFusionVoxelNet")
class BiFusionVoxelNet(SingleStage3DDetector):
    r"""`VoxelNet <https://arxiv.org/abs/1711.06396>`_ for 3D detection."""
    ...
    def __init__(self,
        ...
        print("=======================BiFusionVoxelNet for detectors.voxelnet is used====================")
        pass
    ...
    def extract_feat(self, batch_inputs_dict: dict) -> Tuple[Tensor]:
        ...
        if self.with_neck:
            x = self.neck(x)
        for i,fpn_feat in enumerate(x):
            print("=====================SECONDE FPN OUT{} SHAPE : {}=====================".format(i,fpn_feat.shape))            
        return x
