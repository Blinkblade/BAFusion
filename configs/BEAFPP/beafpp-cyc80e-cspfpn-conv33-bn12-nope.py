...
model = dict(
    ...
    IP_cross_attention = dict(
        type = "CrossEfficientAttention",
        # 都是384
        in_channels = feature_channel,
        key_channels = feature_channel,
        value_channels = feature_channel,
        head_count = int(feature_channel/head_vector_len),
...
# CSP MVXNET 以及完整的逆变换
# python tools/train.py configs/BEAFPP/beafpp-cyc80e-cspfpn-conv33-bn12-nope.py 
