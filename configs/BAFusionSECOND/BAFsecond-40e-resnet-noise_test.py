...
test_evaluator = dict(
    ...
    format_only=True,
    pklfile_prefix='results/kitti-3class/SECOND_RES_40E_kitti_results',
    submission_prefix='results/kitti-3class/SECOND_RES_40E_kitti_results')

# python tools/test.py configs/BAFusionSECOND/BAFsecond-40e-resnet-noise_test.py work_dirs/BAFsecond-40e-resnet-noise/epoch_40.pth
