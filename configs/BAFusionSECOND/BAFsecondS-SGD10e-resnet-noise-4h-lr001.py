...
lr = 0.001
epoch_num = 10
auto_scale_lr = dict(enable=False, base_batch_size=48) # 自动缩放学习率的设置，用来根据基础批量大小来自动调整学习率。
optim_wrapper = dict(
...
# repeat factor is 2, so we actually train 80 epochs.
...
# pretrained = None
load_from = "./work_dirs/BAFsecondS-40e-resnet-noise-4h-autolr/epoch_40.pth"
resume = False

# ./tools/dist_test.sh configs/BAFusionSECOND/BAFsecond-40e-resnet-noise.py work_dirs/BAFsecond-40e-resnet-noise/epoch_40.pth 1

# mmdetection3d/work_dirs/BAFsecond-40e-resnet-noise/epoch_40.pth

# mmdetection3d/configs/BAFusionSECOND/BAFsecond-40e-resnet-noise.py
