...
# 设置一个head， 方便剪枝
# head_vector_len = 64
head_vector_len = feature_channel
# dataset settings
# 测试小数据集
...
model = dict(
    ...
    IP_cross_attention = dict(
        type = "CrossFocusedLinearAttentionPrune",
...
# pretrained = None
load_from = "checkpoints/mm_pruned_bafpp.pth"
resume = False

# python tools/train.py configs/BAFusionPointPillars/bafpp-cyc80e-cspfpn-conv33-bn12-nope-aug-prune-add.py