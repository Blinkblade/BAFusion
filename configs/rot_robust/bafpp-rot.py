...
# pretrained = None
# load_from = "./work_dirs/bafpp-cyc80e-cspfpn-conv33-bn12-nope-aug/epoch_80.pth"
resume = None

# python tools/test.py configs/rot_robust/bafpp-rot.py work_dirs/bafpp-SGD-cspfpn-conv33-bn12-nope-aug/epoch_3.pth 