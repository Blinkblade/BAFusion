...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                type='GlobalRotScaleTrans',
                rot_range=[-0.174532925, 0.174532925],  # ±10 degrees in radians
                scale_ratio_range=[1, 1],  # Scale unchanged
                translation_std=[0.1, 0.1, 0.1]  # Smaller translation std
            ),
