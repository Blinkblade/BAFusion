    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                type='GlobalRotScaleTrans',
                # -45～45
                rot_range=[-0.98539816, 0.98539816],
                # rot_range=[-0.1, 0.1],
...
val_evaluator = dict(
    type='KittiMetricRot', ann_file='data/kitti/kitti_infos_val.pkl')
...
# python tools/test.py configs/rot_robust/mvxnet-80e_kitti-rot.py work_dirs/mvxnet-80e_kitti/epoch_40.pth 
