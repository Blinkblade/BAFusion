...
# pretrained = None
# load_from = "work_dirs/bafpp-cyc80e-cspfpn-conv33-nope-aug/epoch_80.pth"
load_from = None
resume = None

# python tools/test.py configs/rot_robust/bafpp-ad-rot.py work_dirs/bafpp-SGD003-cspfpn-conv33-nope-aug/epoch_9.pth 