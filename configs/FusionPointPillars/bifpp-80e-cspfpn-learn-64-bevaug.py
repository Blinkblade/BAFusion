...
model = dict(
    ...
    middle_encoder=dict(
        ...
        type='PointPillarsScatter', in_channels=feature_channel, output_shape=[496, 432]),
    # 添加图像分支
    # img_backbone=dict(
    #     type='mmdet.ResNet',
    #     depth=50,
    ...
    IP_cross_attention = dict(
        ...
        dim = feature_channel,
        num_patches = None,
        num_heads = int(feature_channel/32),
        # 偏置与尺度,选择None为自动生成
        qkv_bias=False, 
        qk_scale=None, 
        attn_drop=0.1, 
